          ...
          <table class="table">
            ...
            <tbody class="table-border-bottom-0">
              ...
              <tr>
                ...
                <td>
                  <strong class="truncate-text">TOPENG</strong>
                </td>
                <!-- Benahi lagi agar bisa fungsi buat cut judul jadi 2 kata saja -->
                <td>Deskripsi Topeng</td>
              ...
              <tr>
                ...
                <td>
                  ...
                  <strong class="truncate-text">BATIK</strong>
                </td>
                <!-- Benahi lagi agar bisa fungsi buat cut judul jadi 2 kata saja -->
                <script>
              ...
              <tr>
                ...
                <td>
                  <i class="fab fa-angular fa-lg text-danger"></i> 
                  <strong class="truncate-text">ACCESORIS</strong>
                </td>
                <!-- Benahi lagi agar bisa fungsi buat cut judul jadi 2 kata saja -->
                <script>
                  var truncateElement = document.getElementById('truncate');
