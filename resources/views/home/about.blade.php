      ...
      <div class="col-md-6">
        <div class="row">
          ...
          <div class="col-md-6 col-lg-5 d-flex align-self-stretch ftco-animate">
            <div class="services services-1 d-block img" style="background-image: url(images/galeri.jpg);">
              <div class="media-body">
          ...
          <div class="col-md-6 col-lg-5 d-flex align-self-stretch ftco-animate">
            <div class="services services-1 d-block img" style="background-image: url(images/Services-4.png);">
              <div class="media-body">
