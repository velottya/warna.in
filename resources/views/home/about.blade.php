      ...
      <div class="col-md-6">
       <div class="row">
        <div class="col-md-12 col-lg-6 d-flex align-self-stretch ftco-animate">
          <div class="services services-1 d-block img" style="background-image: url(images/services-1.jpg);">
            <div class=" align-items-center justify-content-center"></div>
          </div>
        </div>
        <div class="col-md-12 col-lg-6 d-flex align-self-stretch ftco-animate">
          <div class="services services-1 d-block img" style="background-image: url(images/services-2.jpg);">
            <div class=" align-items-center justify-content-center"></div>
          </div>
        </div>
        <div class="col-md-12 col-lg-6 d-flex align-self-stretch ftco-animate">
          <div class="services services-1 d-block img" style="background-image: url(images/services-3.jpg);">
            <div class=" align-items-center justify-content-center"></div>

          </div>
        </div>
        <div class="col-md-12 col-lg-6 d-flex align-self-stretch ftco-animate">
          <div class="services services-1" style="background-image: url(images/services-4.jpg);">
            <div class=" align-items-center justify-content-center"></div>
